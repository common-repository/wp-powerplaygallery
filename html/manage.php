...
<div class="wrap">
	...
	<form id="add_new_album_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="pp_add_new_album" />
		<table>
		<tr>
	...
	<div class="dataTable_wrapper">
		<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
			...
			<?php pp_get_table_actions(array('pp_bulk_delete_albums' => 'Delete', 
											'pp_bulk_disable_albums' => 'Disable', 
											'pp_bulk_enable_albums' => 'Enable')); ?>
		</div>
	...
	if( isset($_REQUEST['view']) && isset($_REQUEST['album_id']))
	{
		...
		$album = $gpp->pp_get_album($album_id);
		//print_r($album);
		$images = $gpp->pp_get_album_images($album_id);
		//print_r($images); 
